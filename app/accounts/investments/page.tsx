...
const InvestmentsPage = () => {
  ...
  useEffect(() => {
    if (data && data.accounts) {
      setAccounts(data.accounts.filter((a: Account) => a.type === "investment"));
    }
  }, [data]);
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={openAdd} className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"><Plus size={18}/>Add Investment</button>
      </div>
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white rounded shadow-lg p-6 w-full max-w-md relative">
            ...
            <h2 className="text-lg font-semibold mb-4">{editAccount ? 'Edit' : 'Add'} Investment</h2>
